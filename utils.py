...
def load_css(theme_code="light"):
    ...
    <style>
        ...
        /* Sidebar */
        section[data-testid="stSidebar"] {{ background-color: {t['nav_bg']} !important; border-right: 1px solid rgba(0,0,0,0.05); }}
        ...
        .kpi-card, [data-testid="stExpander"], div.stForm, [data-testid="stContainer"] {{ 
            background: var(--card); border-radius: 16px; box-shadow: 0 2px 10px var(--shadow);
        }}
        
        /* Botones */
        div.stButton > button {{ border-radius: 12px; font-weight: 600; border: none; box-shadow: 0 2px 4px var(--shadow); }}
